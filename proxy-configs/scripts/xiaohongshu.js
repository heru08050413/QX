// =====================================================================
// xiaohongshu.js — 小红书去广告/净化/去水印/解除下载限制 (信息流脚本)
// 【镜像自】 fmz200/wool_scripts  Scripts/xiaohongshu/xiaohongshu.js  (作者 @fmz200)
//   源: https://github.com/fmz200/wool_scripts/raw/main/Scripts/xiaohongshu/xiaohongshu.js
//   取回日期: 2026-07-06
// 【为何镜像】 见 zhihu.js 同款说明:去上游死链风险。未改动任何逻辑。
//   本脚本内含 Env() polyfill(自带 isStash()/$environment 判定)+
//   $persistentStore 缓存,Stash 原生可跑。
// =====================================================================
/**
 * @author fmz200
