// =====================================================================
// zhihu.js — 知乎去广告/去推广 (信息流脚本)
// 【镜像自】 fmz200/wool_scripts  Scripts/zhihu/zhihu.js  (作者 @fmz200)
//   源: https://raw.githubusercontent.com/fmz200/wool_scripts/main/Scripts/zhihu/zhihu.js
//   取回日期: 2026-07-06
// 【为何镜像】 直接引上游 raw 链接会因上游删/改路径而"静默死链"
//   (Stash 报 Scripts Not Downloaded)。镜像进本仓库后只受本人控制,
//   死链风险归零;逻辑更新时手动 diff 同步上游即可。未改动任何逻辑。
// =====================================================================
// 2026-01-19 20:50:00
